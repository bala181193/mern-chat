...
function MessageForm() {
    ...
    socket.off("room-messages").on("room-messages", (roomMessages) => {
        console.log("...rowmessage", roomMessages)
        ...
        <div className='messages-output'>
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    <Col md={11}>
                        <Form.Group>
                            <Form.Control type="text" placeholder="Your message" value={message} onChange={(e) => setMessage(e.target.value)} disabled={!user}></Form.Control>
                        </Form.Group>
                    </Col>
                    <Col md={1}>
